...
class Add_Car_ListTile extends StatefulWidget {
  const Add_Car_ListTile({super.key, required this.tileName, required this.carModel});
...
class _Add_Car_ListTileState extends State<Add_Car_ListTile> {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      subtitle:  widget.tileName == "Car Model" ? Text(globals.carData[widget.carModel]['Car Model']) : Text(globals.carData[widget.carModel]['Number Plate']),
      trailing: IconButton(
        icon: Icon(Icons.edit),
        onPressed: () {
          showModalBottomSheet<void>(
                          ...
                          Padding(
                            ...
                            child: ElevatedButton(
                                onPressed: () {
                                  ...
                                  setState(() {
                                    globals.carData[widget.carModel][widget.tileName] =
                                        _currentValue;
                                  });
